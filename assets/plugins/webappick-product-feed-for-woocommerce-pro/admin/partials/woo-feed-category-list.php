...
<div class="wrap"><h2><?php echo _e('Category Mapping List','woo-feed');?>
        <a href="<?php echo admin_url('admin.php?page=woo_feed_category_mapping&action=add-mapping'); ?>"
           class="page-title-action"><?php echo _e('Add New Mapping','woo-feed');?></a>
    </h2>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery('body').find(".single-category-delete").click(function () {
