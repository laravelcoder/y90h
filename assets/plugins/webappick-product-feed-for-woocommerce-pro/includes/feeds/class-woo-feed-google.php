...
class Woo_Feed_Google
{
    ...
    public function __construct($feedRule)
    {
        ...
        $storeProducts = $products->woo_feed_get_visible_product($limit, $offset,$categories);
    ...
    {
        $identifier = array('g:brand', 'g:upc', 'g:sku', 'g:mpn', 'g:gtin');
    ...
    function process_google_shipping_attribute_for_CSVTXT($no)
    {
        ...
        if (count($shippingAttr)) {
            ...
            return $this->products[$no]['shipping(country:service:price)'] = str_replace(" : ", ":", $str);
        }
        return false;
    }
