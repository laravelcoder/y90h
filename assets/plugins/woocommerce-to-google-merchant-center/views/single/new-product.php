...
if ( isset( $product['shipping'] ) && count( $product['shipping'] ) ) {
 ...
 $shop_field[] = array(
    ...
    'html' => '<a href="#" class="button-primary woogool-product-field-addMore">' .__( 'Add More', 'woogool' ) . '</a>
        <a class="button-secondary woogool-product-field-remove" href="#">' . __( 'Cancel', 'woogool' ) . '</a>',
);
//close shippin
...
$shop_field[] = array(
    ...
    'html' => '<a href="#" class="woogool-product-field-addMore">' .__( 'Add More', 'woogool' ) . '</a>
        <a class="woogool-product-field-remove" href="#">' . __( 'Cancel', 'woogool' ) . '</a>',
);*/
...
<a style="margin-left: 24.5%; top: -21px;" class="page-title-action" target="_blank" href="http://mishubd.com/product/woogoo/"><?php _e('Update to pro version for generating unlimited products feed', 'woogool'); ?></a>
<?php
echo '</form>';
echo '</div>';
?>
