...
$feed_fields['all_products'] = array(
    ...
    'desc' => __( 'Select what kind of product feed you want to generate', 'woogool' ),
    'option' => array(
    	'all' => __( 'All', 'woogool' ),
...
$feed_fields['gtin'] = array(
	...
	'desc'     => __( '<a href="http://mishubd.com/wordpress/gtin-for-woocommerce-to-google-merchant-center/" target="_blank">How to generate</a>', 'woogool' ),
	'fields' => array(
        array(
            'label' => __( 'Enable', 'woogool' ),
            'value' => 'on',
...
$feed_fields['sale_price_effective_date'] = array(
	...
	'type'  => 'checkbox',
	'desc'  => __( 'Sale price effective date', 'woogool' ),
    'fields' => array(
        array(
...
<div class="postbox">
		...
		<h3 class="postbox-title">
			<?php _e( 'Product Feed', 'woogool' ); ?>
			<a style="margin-left: 1.5%; top: -1px;" class="page-title-action" target="_blank" href="http://mishubd.com/product/woogoo/"><?php _e('Update pro version for getting this feature', 'woogool'); ?></a>
		</h3>
		<div class="woogool-warning woogool-xml-warning-width page-title-action">
			<?php _e( 'If you did not cofigure your shipping and tax information correctly according 
			to your targeted country and did not verify your website then please do all these things 
		...
		<div class="woogool-feed-form-content">
			...
			<?php
				...
				<a class="button button-primary" target="_blank" href="http://mishubd.com/product/woogoo/"><?php _e('Update pro version for getting this feature', 'woogool'); ?></a>
			</form>
		</div>
		<div class="woogool-clear"></div>
</div>