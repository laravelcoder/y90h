...
if((is_plugin_active('advanced-custom-fields/acf.php')) || (is_plugin_active('advanced-custom-fields-pro/acf.php'))):
	...
	function wpa80367_admin_notice() {
	        ...
	        echo '<strong>ACF PHP VARS Activation Alert!</strong> Please install and activate <a class="thickbox" href="plugin-install.php?tab=plugin-information&plugin=advanced-custom-fields&TB_iframe=true&width=772&height=913">Advanced Custom Fields</a> OR <a class="thickbox" href="https://www.advancedcustomfields.com/pro/?&TB_iframe=true&width=772&height=913">Advanced Custom Fields PRO</a> first to activate ACF PHP VARS. ';
	        echo '</p></div>';
