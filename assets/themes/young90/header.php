...
function dniLoadingTimer() { 
                if (typeof(getDNIRecord) == "function") { 
                                getDNIRecord("cd92cbe966fd3498c1adc65f44aa3656", "dni.logmycalls.com");
                } else { 
...
})(window,document,'script','dataLayer','GTM-K464G3C');</script>
<!-- End Google Tag Manager -->
</head>

<body <?php body_class(); ?>>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K464G3C"
...
?>
	...
	<?php endif; // true ==== $et_top_info_defined ?>
		...
		<header id="main-header" class="<?php echo esc_attr( $primary_nav_class ); ?>">
			...
			?>
				...
				<div id="et-top-navigation">
					<div class="homeonly"><span class="homeonlytext">Independent Distributor</span> <img src="/assets/uploads/2015/06/logo1.jpg" alt="youngevity" height="25" style="height:25px;" /></div>
                    <nav id="top-menu-nav">
					<?php
						$menuClass = 'nav';
		...
		<div id="et-main-area" class="woocommerce">
